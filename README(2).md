...
| Delivery overview                                                       | Article detail                                                    |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------- |
| ![Delivery overview screenshot](docs/screenshots/delivery-overview.png) | ![Article detail screenshot](docs/screenshots/article-detail.png) |
